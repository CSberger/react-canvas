 ...
 */
export function drawImage (ctx, image, x, y, width, height, options) {
  options = options || {};
 ...
 *   {String} backgroundColor
 */
export function drawText (ctx, text, x, y, width, height, fontFace, options) {
  var textMetrics;
  var currX = x;
  var currY = y;
  var currText;
 ...
 */
export function drawGradient(ctx, x1, y1, x2, y2, colorStops, x, y, width, height) {
  var grad;
