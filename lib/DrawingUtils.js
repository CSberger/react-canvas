 ...
 */
export function registerLayerType(type, drawFunction) {
 ...
 */
export function invalidateBackingStore (id) {
  for (var i=0, len=_backingStores.length; i < len; i++) {
    if (_backingStores[i].id === id) {
 ...
 */
export function invalidateAllBackingStores () {
  _backingStores = [];
}
 ...
 * @return {Boolean}
 */
export function layerContainsImage (layer, imageUrl) {
 ...
 * @return {Boolean}
 */
export function layerContainsFontFace (layer, fontFace) {
  // Check the layer itself.
 ...
 * @param {String} imageUrl
 */
export function handleImageLoad (imageUrl) {
 ...
 * @param {FontFace} fontFace
 */
export function handleFontLoad (fontFace) {
  _backingStores.forEach(function (backingStore) {
 ...
 * @param {RenderLayer} layer
 */
export function drawBaseRenderLayer (ctx, layer) {
 ...
 * @private
 */
export function drawGradientRenderLayer (ctx, layer) {
  drawBaseRenderLayer(ctx, layer);
