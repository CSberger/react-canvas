 ...
 * @return {Frame}
 */
export function make (x, y, width, height) {
 ...
 * @return {Frame}
 */
export function intersection (frame, otherFrame) {
 ...
 * @return {Frame}
 */
export function union (frame, otherFrame) {
 ...
 * @return {Boolean}
 */
export function intersects (frame, otherFrame) {
