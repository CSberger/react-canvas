...
const { registerLayerType, glUtils, createCanvasComponent, ThreeJSSurface } = ReactCanvas;
...
registerLayerType('ThreeJSsphere', function (ctx, layer) {
    var x = layer.frame.x; 
    var y = layer.frame.y;
...
const Sphere = createCanvasComponent({
  displayName: 'ThreeJSSphere',
  layerType: 'ThreeJSsphere',
